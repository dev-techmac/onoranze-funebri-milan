...
trait Menu
{
    ...
    {
        static::$code = FLAMIX_BITRIX24_ELEMENTOR_FORMS_CODE;
        static::$dir = FLAMIX_BITRIX24_ELEMENTOR_FORMS_DIR;
    ...
    public static function add_link_to_plugin_widget(array $links): array
    {
        ...
        $plugin_link = '<a target="_blank" href="' . static::PLUGIN_URL . '">' . esc_html__('Bitrix24 Plugin', 'flamix-bitrix24-and-elementor-forms-integration') . '</a>';
