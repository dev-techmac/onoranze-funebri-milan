...
/**
 * Title: Achievements
 * Slug: nutri-coach/achievements
 * Categories: nutri-coach
 */

$img            = get_template_directory_uri() . '/assets/images/';
$icon_education = esc_url( $img . 'education-qualifications.png' );
$icon_coaching  = esc_url( $img . 'coaching.png' );
$cert_1         = esc_url( $img . 'cert-1.webp' );
$cert_2         = esc_url( $img . 'cert-2.webp' );
$cert_3         = esc_url( $img . 'cert-3.webp' );
$cert_4         = esc_url( $img . 'cert-4.webp' );
?>
<!-- wp:group {"tagName":"section","metadata":{"name":"Achievements","patternName":"nutri-coach/achievements","categories":["nutri-coach-achievements"]},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80","left":"var:preset|spacing|50","right":"var:preset|spacing|50"},"blockGap":"0"}},"backgroundColor":"background-dark","layout":{"type":"constrained","wideSize":"1200px"}} -->
...
<p class="has-text-align-left has-text-color has-small-font-size" style="color:var(--wp--preset--color--primary);margin-top:0;margin-bottom:0;font-weight:600;letter-spacing:var(--wp--custom--typography--letter-spacing--label);text-transform:uppercase">Certificates</p>
<!-- /wp:paragraph -->
...
<p class="has-text-color has-fraunces-font-family" style="color:var(--wp--preset--color--heading-text);margin-top:0;margin-bottom:0;font-size:18px;font-style:normal;font-weight:600;letter-spacing:var(--wp--custom--typography--letter-spacing--heading-xs)">Education</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-column"><!-- wp:group {"style":{"spacing":{"blockGap":"4px","margin":{"top":"0","bottom":"0"}},"dimensions":{"minHeight":"0px"}},"layout":{"type":"flex","orientation":"vertical"}} -->
<div class="wp-block-group" style="min-height:0px;margin-top:0;margin-bottom:0"><!-- wp:paragraph {"style":{"typography":{"fontSize":"18px","fontWeight":"600","letterSpacing":"var(--wp--custom--typography--letter-spacing--heading-xs)","fontStyle":"normal"},"spacing":{"margin":{"top":"0","bottom":"0"}},"color":{"text":"var:preset|color|heading-text"}},"fontFamily":"fraunces"} -->
<p class="has-text-color has-fraunces-font-family" style="color:var(--wp--preset--color--heading-text);margin-top:0;margin-bottom:0;font-size:18px;font-style:normal;font-weight:600;letter-spacing:var(--wp--custom--typography--letter-spacing--heading-xs)">Coaching Experience</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"typography":{"fontSize":"var(--wp--preset--font-size--medium)","lineHeight":"var(--wp--custom--typography--line-height--standard)","fontWeight":"400","fontStyle":"normal"},"spacing":{"margin":{"top":"0","bottom":"0"}},"color":{"text":"var:preset|color|paragraph-text"}}} -->
<p class="has-text-color" style="color:var(--wp--preset--color--paragraph-text);margin-top:0;margin-bottom:0;font-size:var(--wp--preset--font-size--medium);font-style:normal;font-weight:400;line-height:var(--wp--custom--typography--line-height--standard)">10+ years coaching 2,400+ clients across 32 countries — from hospital wards to a thriving private practice and signature 12-week program.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
