...
/**
 * Title: Footer
 * Slug: nutri-coach/footer
 * Categories: nutri-coach
 */

$img        = get_template_directory_uri() . '/assets/images/';
$logo_url   = esc_url( $img . rawurlencode( 'nutri-coach-logo.png' ) );
$rating_url = esc_url( $img . rawurlencode( 'rating.png' ) );
?>
<!-- wp:group {"metadata":{"name":"Nutri Coach – Footer","categories":["nutri-coach-footer"],"patternName":"nutri-coach/footer","description":"Footer with brand blurb, CTA button, three navigation columns, and a bottom bar with social links."},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|40","left":"var:preset|spacing|50","right":"var:preset|spacing|50"},"blockGap":"0"},"color":{"background":"var:preset|color|white"}},"layout":{"type":"constrained","wideSize":"1200px"}} -->
...
<figure class="wp-block-image size-full is-resized" style="margin-top:-5px;margin-bottom:0px"><img src="<?php echo $logo_url; ?>" alt="Nutri Coach Logo" style="object-fit:contain;object-position:39% 12%;width:20px;height:20px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
...
<div class="wp-block-group"><!-- wp:image {"width":"90px","sizeSlug":"full","linkDestination":"none","align":"center"} -->
<figure class="wp-block-image aligncenter size-full is-resized"><img src="<?php echo $rating_url; ?>" alt="" style="width:90px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
...
<p class="has-text-color has-inter-font-family" style="color:var(--wp--preset--color--paragraph-text);margin-top:3px;margin-bottom:0;font-size:14px;font-style:normal;font-weight:400;letter-spacing:0.3px">Loved by 2,400+ clients worldwide</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<p class="has-text-color has-medium-font-size" style="color:var(--wp--preset--color--primary);margin-top:0;margin-bottom:0;font-style:normal;font-weight:500;letter-spacing:0.3px;text-transform:capitalize">Explore</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-column"><!-- wp:paragraph {"style":{"typography":{"fontWeight":"500","letterSpacing":"0.3px","textTransform":"capitalize","fontStyle":"normal"},"spacing":{"margin":{"top":"0","bottom":"0"}},"color":{"text":"var:preset|color|primary"}},"fontSize":"medium"} -->
<p class="has-text-color has-medium-font-size" style="color:var(--wp--preset--color--primary);margin-top:0;margin-bottom:0;font-style:normal;font-weight:500;letter-spacing:0.3px;text-transform:capitalize">Work with me</p>
<!-- /wp:paragraph -->
...
<p class="has-text-color has-medium-font-size" style="color:var(--wp--preset--color--primary);margin-top:0;margin-bottom:0;font-style:normal;font-weight:500;letter-spacing:0.3px;text-transform:capitalize">Company</p>
<!-- /wp:paragraph -->
...
<p class="has-text-color" style="color:var(--wp--preset--color--muted-text);margin-top:0;margin-bottom:0;font-size:14px;font-weight:400"><?php echo esc_html( '© ' . date( 'Y' ) . ' Nutri Coach' ); ?></p>
<!-- /wp:paragraph -->
