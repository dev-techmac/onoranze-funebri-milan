...
/**
 * Title: Archive
 * Slug: nutri-coach/archive
 * Categories: nutri-coach
 */
?>
<!-- wp:group {"tagName":"section","metadata":{"name":"Archive Page","patternName":"nutri-coach/archive","categories":["nutri-coach-archive"]},"align":"full","style":{"spacing":{"blockGap":"0","margin":{"top":"0","bottom":"0"}}},"layout":{"type":"default"}} -->
...
<p class="has-text-align-center has-text-color has-white-color" style="margin-top:0;margin-bottom:0;font-size:12px;font-weight:600;letter-spacing:var(--wp--custom--typography--letter-spacing--label);text-transform:uppercase">Browsing</p>
<!-- /wp:paragraph -->
...
<!-- wp:term-description {"style":{"typography":{"fontSize":"var(--wp--preset--font-size--heading-h6)","lineHeight":"var(--wp--custom--typography--line-height--body)","textAlign":"center"},"color":{"text":"rgba(255,255,255,0.65)"},"spacing":{"margin":{"top":"0","bottom":"0"}}}} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<p class="has-text-align-center has-text-color" style="color:var(--wp--preset--color--paragraph-text);margin-top:0;margin-bottom:0;font-size:var(--wp--preset--font-size--heading-h6);line-height:var(--wp--custom--typography--line-height--body)">Nothing found. Try browsing a different category.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- /wp:query-no-results -->
