...
/**
 * Title: Home
 * Slug: nutri-coach/home
 * Categories: nutri-coach
 */
?>
<!-- wp:group {"tagName":"section","metadata":{"name":"Blog Home","patternName":"nutri-coach/home","categories":["nutri-coach-home"]},"align":"full","style":{"spacing":{"blockGap":"0","margin":{"top":"0","bottom":"0"}}},"layout":{"type":"default"}} -->
<section class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0"><!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|70","bottom":"var:preset|spacing|70","left":"var:preset|spacing|50","right":"var:preset|spacing|50"},"margin":{"top":"0","bottom":"0"}}},"backgroundColor":"primary-dark","layout":{"type":"constrained","wideSize":"800px"}} -->
<div class="wp-block-group alignfull has-primary-dark-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--70);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--50)"><!-- wp:group {"style":{"spacing":{"blockGap":"16px"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"center"}} -->
...
<p class="has-text-align-center has-text-color has-white-color" style="margin-top:0;margin-bottom:0;font-size:12px;font-weight:600;letter-spacing:var(--wp--custom--typography--letter-spacing--label);text-transform:uppercase">The Blog</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":1,"className":"wp-block-heading has-text-align-center has-fraunces-font-family has-heading-h2-font-size","style":{"typography":{"fontWeight":"600","lineHeight":"var(--wp--custom--typography--line-height--heading)","letterSpacing":"var(--wp--custom--typography--letter-spacing--heading)","fontStyle":"normal"},"spacing":{"margin":{"top":"0","bottom":"0"}}},"textColor":"white","fontSize":"heading-h1"} -->
<h1 class="wp-block-heading has-text-align-center has-fraunces-font-family has-heading-h2-font-size has-white-color has-text-color has-heading-h-1-font-size" style="margin-top:0;margin-bottom:0;font-style:normal;font-weight:600;letter-spacing:var(--wp--custom--typography--letter-spacing--heading);line-height:var(--wp--custom--typography--line-height--heading)">Latest Articles</h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"className":"has-white-color has-text-color","style":{"typography":{"fontSize":"var(--wp--preset--font-size--heading-h6)","lineHeight":"var(--wp--custom--typography--line-height--body)","textAlign":"center","fontStyle":"normal","fontWeight":"400"},"spacing":{"margin":{"top":"0","bottom":"0"}}},"textColor":"white","fontFamily":"inter"} -->
<p class="has-text-align-center has-white-color has-text-color has-inter-font-family" style="margin-top:0;margin-bottom:0;font-size:var(--wp--preset--font-size--heading-h6);font-style:normal;font-weight:400;line-height:var(--wp--custom--typography--line-height--body)">Tips, recipes, and insights to help you eat better and live stronger.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<!-- wp:post-title {"isLink":true,"style":{"typography":{"fontWeight":"600","lineHeight":"var(--wp--custom--typography--line-height--card-title-lg)","letterSpacing":"var(--wp--custom--typography--letter-spacing--heading-sm)","fontStyle":"normal"},"color":{"text":"var:preset|color|heading-text"},"spacing":{"margin":{"top":"0","bottom":"0"}},"elements":{"link":{"color":{"text":"var:preset|color|heading-text"},":hover":{"color":{"text":"var:preset|color|primary"}}}}},"fontSize":"heading-h2","fontFamily":"fraunces"} /-->

<!-- wp:post-excerpt {"moreText":"Read article","style":{"typography":{"fontSize":"var(--wp--preset--font-size--medium)","lineHeight":"var(--wp--custom--typography--line-height--body)","fontStyle":"normal","fontWeight":"400"},"color":{"text":"var:preset|color|paragraph-text"},"spacing":{"margin":{"top":"0","bottom":"0"}}},"fontFamily":"inter"} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
<!-- /wp:post-template -->
...
<p class="has-text-align-center has-text-color" style="color:var(--wp--preset--color--paragraph-text);margin-top:0;margin-bottom:0;font-size:var(--wp--preset--font-size--heading-h6);line-height:var(--wp--custom--typography--line-height--body)">No posts found. Check back soon!</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
<!-- /wp:query-no-results -->
