<?php
/**
 * Title: Program Detail Hero
 * Slug: nutri-coach/program-detail-hero
 * Categories: nutri-coach
 */

$image = esc_url( get_template_directory_uri() . '/assets/images/program-1.webp' );
?>
<!-- wp:group {"tagName":"section","metadata":{"name":"Program Detail Hero","patternName":"nutri-coach/program-detail-hero","categories":["nutri-coach-program-detail-hero"]},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80","left":"var:preset|spacing|50","right":"var:preset|spacing|50"},"blockGap":"0"},"color":{"background":"var:preset|color|background-light"}},"layout":{"type":"constrained","wideSize":"1200px"}} -->
...
<p class="has-text-align-left has-text-align-center has-text-color has-small-font-size" style="color:var(--wp--preset--color--primary);margin-top:0;margin-bottom:0;font-weight:600;letter-spacing:var(--wp--custom--typography--letter-spacing--label);text-transform:uppercase">10 WEEKS</p>
<!-- /wp:paragraph -->
...
<p class="has-text-color has-large-font-size" style="color:var(--wp--preset--color--paragraph-text);margin-top:0;margin-bottom:0;font-weight:400;line-height:var(--wp--custom--typography--line-height--body)">Ten weeks to confidently shift toward a plant-forward way of eating — fully covered for protein, iron, B12 and omega-3, with recipes you'll actually want to repeat.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<p class="has-text-color has-fraunces-font-family" style="color:var(--wp--preset--color--heading-text);margin-top:0;margin-bottom:0;font-size:28px;font-style:normal;font-weight:600;line-height:var(--wp--custom--typography--line-height--flat)">$179</p>
<!-- /wp:paragraph -->
...
<p class="has-text-color" style="color:var(--wp--preset--color--muted-text);margin-top:0;margin-bottom:0;font-size:var(--wp--preset--font-size--small);font-weight:400;line-height:var(--wp--custom--typography--line-height--button)">/ One-time payment</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
