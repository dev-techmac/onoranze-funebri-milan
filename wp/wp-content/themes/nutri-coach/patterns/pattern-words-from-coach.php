...
<figure class="wp-block-image size-full is-resized has-custom-border"><img src="<?php echo $avatar; ?>" alt="Sarah Whitman" style="border-radius:99px;object-fit:cover;width:52px;height:52px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group -->
...
<p class="has-text-color" style="color:var(--wp--preset--color--white);margin-top:0;margin-bottom:0;font-size:var(--wp--preset--font-size--small);font-weight:500">Sarah Whitman, RD · Founder</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></section>
<!-- /wp:group -->
