...
/**
 * Title: Social Media
 * Slug: nutri-coach/social-media
 * Categories: nutri-coach
 */

$img  = get_template_directory_uri() . '/assets/images/';
$ig_1 = esc_url( $img . 'cta-right.webp' );
$ig_2 = esc_url( $img . 'blog-4.jpg' );
$ig_3 = esc_url( $img . 'insta-3.jpg' );
$ig_4 = esc_url( $img . 'transform-3.webp' );
$ig_5 = esc_url( $img . 'food.webp' );
$ig_6 = esc_url( $img . 'blog-3.jpg' );
?>
<!-- wp:group {"tagName":"section","metadata":{"name":"Social Media","patternName":"nutri-coach/social-media","categories":["nutri-coach-social-media"]},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80","left":"var:preset|spacing|50","right":"var:preset|spacing|50"},"blockGap":"0"},"color":{"background":"var:preset|color|background-light"}},"layout":{"type":"constrained","wideSize":"1200px"}} -->
<section class="wp-block-group alignfull has-background" style="background-color:var(--wp--preset--color--background-light);padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--50)"><!-- wp:columns -->
...
<p class="has-text-align-center has-text-color has-small-font-size" style="color:var(--wp--preset--color--primary);margin-top:0;margin-bottom:0;font-weight:600;letter-spacing:var(--wp--custom--typography--letter-spacing--label);text-transform:uppercase">Instagram</p>
<!-- /wp:paragraph -->
